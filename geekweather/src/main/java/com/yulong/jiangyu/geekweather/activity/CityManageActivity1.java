...
public class CityManageActivity1 extends AppCompatActivity implements IView {
...
//            final String weatherCode = cityEntity.getWeatherCode();
            ...
            mWeatherPresenter.requestWeather(cityEntity.getWeatherCode(), true);
        ...
        gvCityManage.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (position == mCityManageEntityList.size() - 1) {// 最后一项添加城市
                    Intent intent = new Intent(CityManageActivity1.this, AddCityActivity.class);
    ...
    private void refresh() {
        ...
        for (final CityManageEntity cityManageEntity : mCityManageEntityList) {
            ...
            if (size == 1 || count == size - 1)
                break;
            mWeatherPresenter.requestWeather(cityManageEntity.getWeatherCode(), true);
//            // 请求天气数据
...
//        private final WeakReference<CityManageActivity1> mActivity;
//
//        public MyHandler(CityManageActivity1 activity) {
//            mActivity = new WeakReference<CityManageActivity1>(activity);
//        }
//
//        @Override
//        public void handleMessage(Message msg) {
//            super.handleMessage(msg);
//            CityManageActivity1 activity = mActivity.get();
//            // 鲁棒性检查
//            if (activity == null)
//                return;
//            switch (msg.what) {
