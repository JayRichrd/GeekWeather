...
public class CityManageEntityDBHelper extends OrmLiteSqliteOpenHelper {
    private static CityManageEntityDBHelper instance = null;

    private CityManageEntityDBHelper(Context context) {
     ...
     */
    public static synchronized CityManageEntityDBHelper getInstance(Context context) {
        if (null == instance) {
            synchronized (CityManageEntityDBHelper.class) {
                if (null == instance) {
                    instance = new CityManageEntityDBHelper(context);
                }
            }
        }
        return instance;
