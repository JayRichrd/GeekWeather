...
public class WthrcdnWeatherEntity implements IDataEntity {
    ...
    //多天天气预报
    private List<WthrcdnWeatherForecastDaysEntity> mWeatherDaysForecasts;
    //生活指数
    ...
    public List<WthrcdnWeatherForecastDaysEntity> getmWeatherDaysForecasts() {
        return mWeatherDaysForecasts;
    }

    public void setmWeatherDaysForecasts(List<WthrcdnWeatherForecastDaysEntity> mWeatherDaysForecasts) {
